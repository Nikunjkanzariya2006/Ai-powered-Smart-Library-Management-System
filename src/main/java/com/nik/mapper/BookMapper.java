...
public class BookMapper {
    ...
    public BookDTO toDTO(Book book) {
        ...
        if (book.getGenre() != null) {
            ...
            dto.setGenreClassificationSystem(book.getGenre().getClassificationSystem());
            dto.setGenreClassificationCode(book.getGenre().getClassificationCode());
            dto.setGenreHierarchyPath(book.getGenre().getHierarchyPath());
        }
        ...
        dto.setDeweyDecimal(book.getDeweyDecimal());
        dto.setLibraryOfCongressCode(book.getLibraryOfCongressCode());
        dto.setCallNumber(book.getCallNumber());
        dto.setAudienceLevel(book.getAudienceLevel());
        dto.setSubjectHeadings(book.getSubjectHeadings());
    ...
    public Book toEntity(BookDTO dto) throws BookException {
        ...
        book.setDeweyDecimal(dto.getDeweyDecimal());
        book.setLibraryOfCongressCode(dto.getLibraryOfCongressCode());
        book.setCallNumber(dto.getCallNumber());
        book.setAudienceLevel(dto.getAudienceLevel());
        book.setSubjectHeadings(dto.getSubjectHeadings());
