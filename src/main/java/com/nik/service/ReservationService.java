...
public interface ReservationService {
    ...
    /**
     * Promote pending reservations to AVAILABLE when a copy is available.
     * Useful as a safety-net for inventory changes outside normal return flow.
     * @return Number of reservations promoted to AVAILABLE
     */
    int processPendingReservationsForAvailableBooks();
